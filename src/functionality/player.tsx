...
export class player {
   ...
   */
  flatDamage(p: number, m: number = 0, a: number = 0, overHeal: boolean = false): number {
    if (p > 0) {
  ...
  calculateBattleManaRegen(): void {
    ...
    this.modifyBattleManaRegen(this.chestPlate.getBattleManaRegenModifier());
  ...
  calculateArmour(): void {
    ...
    this.modifyFlatMagicArmour(this.chestPlate.getFlatMagicArmourModifier());
    ...
    this.modifyPropMagicArmour(this.chestPlate.getPropMagicArmourModifier());
  ...
  modifyPropMagicDamageModifier(p: number): void {
    ...
    this.propMagicDamageModifier = (this.propMagicDamageModifier + 1) * (p + 1) - 1;
  }
  ...
  modifyPropArmourPiercingDamageModifier(p: number): void {
    ...
    this.propArmourPiercingDamageModifier = (this.propArmourPiercingDamageModifier + 1) * (p + 1) - 1;
  }
  calculateDamageModifiers(): void {
    ...
    this.modifyFlatMagicDamageModifier(this.helmet.getFlatMagicDamageModifier());
    this.modifyFlatMagicDamageModifier(this.chestPlate.getFlatMagicDamageModifier());
    this.modifyFlatMagicDamageModifier(this.greaves.getFlatMagicDamageModifier());
    this.modifyFlatMagicDamageModifier(this.boots.getFlatMagicDamageModifier());
    for (let weaponry of this.weapons) {
      if (weaponry.getReal()) {
        this.modifyFlatMagicDamageModifier(weaponry.getFlatMagicDamageModifier());
      }
    }
    //Prop magic
    this.propMagicDamageModifier = this.propMagicDamageModifierBase;
    this.modifyPropMagicDamageModifier(this.helmet.getPropMagicDamageModifier());
    this.modifyPropMagicDamageModifier(this.chestPlate.getPropMagicDamageModifier());
    this.modifyPropMagicDamageModifier(this.greaves.getPropMagicDamageModifier());
    this.modifyPropMagicDamageModifier(this.boots.getPropMagicDamageModifier());
    //Flat AP
    this.flatArmourPiercingDamageModifier = this.flatArmourPiercingDamageModifierBase;
    this.modifyFlatArmourPiercingDamageModifier(this.helmet.getFlatArmourPiercingDamageModifier());
    this.modifyFlatArmourPiercingDamageModifier(this.chestPlate.getFlatArmourPiercingDamageModifier());
    this.modifyFlatArmourPiercingDamageModifier(this.greaves.getFlatArmourPiercingDamageModifier());
    this.modifyFlatArmourPiercingDamageModifier(this.boots.getFlatArmourPiercingDamageModifier());
    //Prop AP
    this.propArmourPiercingDamageModifier = this.propArmourPiercingDamageModifierBase;
    this.modifyPropArmourPiercingDamageModifier(this.helmet.getPropArmourPiercingDamageModifier());
    this.modifyPropArmourPiercingDamageModifier(this.chestPlate.getPropArmourPiercingDamageModifier());
    this.modifyPropArmourPiercingDamageModifier(this.greaves.getPropArmourPiercingDamageModifier());
    this.modifyPropArmourPiercingDamageModifier(this.boots.getPropArmourPiercingDamageModifier());
  }
  ...
  calculateCounterAttackChance(): void {
    ...
    this.modifyCounterAttackChance(this.helmet.getCounterAttackChanceModifier());
    this.modifyCounterAttackChance(this.chestPlate.getCounterAttackChanceModifier());
    this.modifyCounterAttackChance(this.greaves.getCounterAttackChanceModifier());
    this.modifyCounterAttackChance(this.boots.getCounterAttackChanceModifier());
  }
  ...
  turnStart(): void {
    this.modifyHealth(-(BATTLE_VALUES.POISON_MULTIPLIER * this.poison + BATTLE_VALUES.BLEED_MULTIPLIER * this.bleed));
    this.modifyHealth(this.turnRegen + BATTLE_VALUES.REGEN_MULTIPLIER * this.tempRegen);
    if (this.health > this.maxHealth) {
      this.health = Math.max(this.maxHealth, this.health - PLAYER_VALUES.PLAYER_OVERHEAL_DECAY);
    }
    this.modifyMana(this.turnManaRegen);
    if (this.mana > this.maxMana) {
      this.mana = Math.max(this.maxMana, this.mana - PLAYER_VALUES.MANA_DECAY);
    }
    if (this.poison > 0) {
      this.poison--;
    }
  ...
  constructor(playerClass?: string | player) {
    if (playerClass) {
      if (typeof playerClass == "string") {
        ...
        for (let weaponry of playerClass.weapons) {
          this.weapons.push(new weapon(weaponry));
        }
        for (let magic of playerClass.spells) {
          this.spells.push(new spell(magic));
        }
        ...
        this.flatDamageModifierBase = playerClass.flatDamageModifierBase;
        this.flatDamageModifier = playerClass.flatDamageModifier;
        this.propDamageModifierBase = playerClass.propDamageModifierBase;
        this.propDamageModifier = playerClass.propDamageModifier;
        this.flatMagicDamageModifierBase = playerClass.flatMagicDamageModifierBase;
        this.flatMagicDamageModifier = playerClass.flatMagicDamageModifier;
        this.propMagicDamageModifierBase = playerClass.propMagicDamageModifierBase;
        this.propMagicDamageModifier = playerClass.propMagicDamageModifier;
        this.flatArmourPiercingDamageModifierBase = playerClass.flatArmourPiercingDamageModifierBase;
        this.flatArmourPiercingDamageModifier = playerClass.flatArmourPiercingDamageModifier;
        this.propArmourPiercingDamageModifierBase = playerClass.propArmourPiercingDamageModifierBase;
        this.propArmourPiercingDamageModifier = playerClass.propArmourPiercingDamageModifier;
        this.evadeChanceBase = playerClass.evadeChanceBase;
        this.evadeChance = playerClass.evadeChance;
        this.counterAttackChanceBase = playerClass.counterAttackChanceBase;
  ...
  loadClass(playerClass: string): void {
    ...
    this.projectiles = this.turnRegenBase = 0;
    this.battleRegenBase = 0;
    this.weapons.length = 0;
    this.spells.length = 0;
    this.flatArmourBase = 0;
    this.propArmourBase = 0;
    this.flatMagicArmourBase = 0;
    this.propMagicArmourBase = 0;
    this.flatDamageModifierBase = 0;
    this.propDamageModifierBase = 0;
    this.flatMagicDamageModifierBase = 0;
    this.propMagicDamageModifierBase = 0;
    this.flatArmourPiercingDamageModifierBase = 0;
    this.propArmourPiercingDamageModifierBase = 0;
    this.xp = 0;
    this.maxXp = 0;
    this.maxManaBase = 100;
    this.turnManaRegenBase = 5;
    this.battleManaRegenBase = 10;
    this.initiativeBase = 10;
    this.poisonResistBase = 0.1;
    this.bleedResistBase = 0.1;
    this.evadeChanceBase = 0.1;
    this.counterAttackChanceBase = 0.1;
    this.bonusActionsBase = 1;
    this.level = 1;
    ...
    switch (typeof selectedClass.maxHealth) {
      case "number":
        ...
        break;
      case "string":
        this.maxHealthBase = numFromString(selectedClass.maxHealth).value;
    }
    switch (typeof selectedClass.projectiles) {
      case "number":
        ...
        break;
      case "string":
        this.projectiles = numFromString(selectedClass.projectiles).value;
    }
    ...
    switch (typeof selectedClass.turnManaRegen) {
      case "number":
        this.turnManaRegenBase = Math.trunc(selectedClass.turnManaRegen);
        break;
      case "string":
        this.turnManaRegenBase = numFromString(selectedClass.turnManaRegen).value;
    }
    switch (typeof selectedClass.battleManaRegen) {
      case "number":
        this.battleManaRegenBase = Math.trunc(selectedClass.battleManaRegen);
        break;
      case "string":
        this.battleManaRegenBase = numFromString(selectedClass.battleManaRegen).value;
    }
    switch (typeof selectedClass.poisonResist) {
      case "number":
        ...
        break;
      case "string":
        this.poisonResistBase = floatFromString(selectedClass.poisonResist).value;
    }
    ...
    switch (typeof selectedClass.bleedResist) {
      case "number":
        ...
        break;
      case "string":
        this.bleedResistBase = floatFromString(selectedClass.bleedResist).value;
    }
    ...
    switch (typeof selectedClass.turnRegen) {
      case "number":
        ...
        break;
      case "string":
        this.turnRegenBase = numFromString(selectedClass.turnRegen).value;
    }
    ...
    switch (typeof selectedClass.flatArmour) {
      case "number":
        ...
        break;
      case "string":
        this.flatArmourBase = numFromString(selectedClass.flatArmour).value;
    }
    switch (typeof selectedClass.propArmour) {
      case "number":
        ...
        break;
      case "string":
        this.propArmourBase = floatFromString(selectedClass.propArmour).value;
    }
    ...
    switch (typeof selectedClass.flatMagicArmour) {
      case "number":
        this.flatMagicArmourBase = Math.trunc(selectedClass.flatMagicArmour);
        break;
      case "string":
        this.flatMagicArmourBase = numFromString(selectedClass.flatMagicArmour).value;
    }
    switch (typeof selectedClass.propMagicArmour) {
      case "number":
        ...
        break;
      case "string":
        this.propMagicArmourBase = floatFromString(selectedClass.propMagicArmour).value;
    }
    ...
    switch (typeof selectedClass.flatDamageModifier) {
      case "number":
        this.flatDamageModifierBase = Math.trunc(selectedClass.flatDamageModifier);
        break;
      case "string":
        this.flatDamageModifierBase = numFromString(selectedClass.flatDamageModifier).value;
    }
    switch (typeof selectedClass.propDamageModifier) {
      case "number":
        ...
        break;
      case "string":
        this.propDamageModifierBase = floatFromString(selectedClass.propDamageModifier).value;
    }
    ...
    switch (typeof selectedClass.flatMagicDamageModifier) {
      case "number":
        this.flatMagicDamageModifierBase = Math.trunc(selectedClass.flatMagicDamageModifier);
        break;
      case "string":
        this.flatMagicDamageModifierBase = numFromString(selectedClass.flatMagicDamageModifier).value;
    }
    switch (typeof selectedClass.propMagicDamageModifier) {
      case "number":
        this.propMagicDamageModifierBase = selectedClass.propMagicDamageModifier;
        break;
      case "string":
        this.propMagicDamageModifierBase = floatFromString(selectedClass.propMagicDamageModifier).value;
    }
    ...
    switch (typeof selectedClass.flatArmourPiercingDamageModifier) {
      case "number":
        this.flatArmourPiercingDamageModifierBase = Math.trunc(selectedClass.flatArmourPiercingDamageModifier);
        break;
      case "string":
        this.flatArmourPiercingDamageModifierBase = numFromString(selectedClass.flatArmourPiercingDamageModifier).value;
    }
    switch (typeof selectedClass.propArmourPiercingDamageModifier) {
      case "number":
        this.propArmourPiercingDamageModifierBase = selectedClass.propArmourPiercingDamageModifier;
        break;
      case "string":
    ...
    switch (typeof selectedClass.evadeChance) {
      case "number":
        ...
        break;
      case "string":
        this.evadeChanceBase = floatFromString(selectedClass.evadeChance).value;
    }
    ...
    switch (typeof selectedClass.counterAttackChance) {
      case "number":
        this.counterAttackChanceBase = selectedClass.counterAttackChance;
        break;
      case "string":
        this.counterAttackChanceBase = floatFromString(selectedClass.counterAttackChance).value;
    }
    ...
    switch (typeof selectedClass.bonusActions) {
      case "number":
        ...
        break;
      case "string":
        this.bonusActionsBase = numFromString(selectedClass.bonusActions).value;
    }
    switch (typeof selectedClass.initiative) {
      case "number":
        ...
        break;
      case "string":
        this.initiativeBase = numFromString(selectedClass.initiative).value;
    }
  ...
  check(type: boolean, timing: 0 | 1 | 2 | 3 | 4, slot: number): boolean {
    if (type) {
      if (slot < 0 || slot >= this.spells.length || !this.spells[slot].getReal()) {
        return false;
      }
      switch (timing) {
        //Main action
        case 0:
          if (this.spells[slot].getTiming() == 2 || this.spells[slot].getHitCount() <= 0) {
            return false;
          }
          break;
        ...
        case 4:
          if (this.spells[slot].getTiming() == 0 || this.currentBonusActions <= 0) {
            return false;
          }
          break;
        //Counter attacking
        case 3:
          if (this.spells[slot].getCounterHits() <= 0 || this.currentBonusActions <= 0) {
            return false;
          }
          break;
      }
      if (
        ...
        (this.spells[slot].getManaChange() < 0 && this.mana + this.spells[slot].getManaChange() < 0) ||
        (this.spells[slot].getHealthChange() < 0 && this.health + this.spells[slot].getHealthChange() < 0) ||
        (this.spells[slot].getProjectileChange() < 0 && this.projectiles + this.spells[slot].getProjectileChange() < 0)
      ) {
        return false;
      }
    } else {
      if (slot < 0 || slot >= this.weapons.length || !this.weapons[slot].getReal()) {
        return false;
      }
      switch (timing) {
        case 0:
          ...
          break;
        case 3:
          if (this.weapons[slot].getCounterHits() <= 0 || this.currentBonusActions <= 0) {
            return false;
          }
          break;
        case 1:
      ...
      if (
        (this.weapons[slot].getProjectileChange() < 0 &&
          this.projectiles + this.weapons[slot].getProjectileChange() < 0) ||
        (this.weapons[slot].getManaChange() < 0 && this.mana + this.weapons[slot].getManaChange() < 0) ||
        (this.weapons[slot].getHealthChange() < 0 && this.health + this.weapons[slot].getHealthChange() < 0)
      ) {
        return false;
      }
    }
   ...
   */
  checkDualWeapons(timing: 0 | 1 | 2 | 3 | 4, slot1: number, slot2: number): boolean {
    if (slot1 == slot2) {
      return false;
    }
    if (
    ...
    if (!this.weapons[slot1].getDualWield() || !this.weapons[slot2].getDualWield()) {
      return false;
    }
    if (!this.check(false, timing, slot1) || !this.check(false, timing, slot2)) {
      return false;
    }
    ...
    let totHealthChange: number = this.weapons[slot1].getHealthChange() + this.weapons[slot2].getHealthChange();
    let totManaChange: number = this.weapons[slot1].getManaChange() + this.weapons[slot2].getManaChange();
    let totProjectileChange: number =
      this.weapons[slot1].getProjectileChange() + this.weapons[slot2].getProjectileChange();
    if (
      (totHealthChange < 0 && this.health + totHealthChange < 0) ||
      (totManaChange < 0 && this.mana + totManaChange < 0) ||
      (totProjectileChange < 0 && this.projectiles + totProjectileChange < 0)
    ) {
      return false;
    }
    return true;
