  ...
  return (
    <IonPage>
      ...
      <IonFooter>
        <IonToolbar>
          <IonButtons slot="end">
            <IonButton mode="ios" onClick={() => setIsBattleLogOpen(true)}>
              Battle Log
            </IonButton>
            <IonModal isOpen={isBattleLogOpen} onDidDismiss={() => setIsBattleLogOpen(false)}>
              <IonHeader>
                <IonToolbar>
                  <IonButtons slot="start">
...
export function* battleHandler(
          ...
          if (enemySelection.actionType == 2) {
            ...
            if (responseSpellBuffer.getCounterSpell() == 1 || responseSpellBuffer.getCounterSpell() == 3) {
              if (spellBuffer.getNoCounter()) {
                opponent.addNoCounter(true, spellBuffer.getName());
  ...
  function EndBattleButton(): React.ReactNode {
    return (
      <IonButton mode="ios" onClick={endBattle}>
        End battle
      </IonButton>
